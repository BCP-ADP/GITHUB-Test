...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 System.Xml.Serialization.XmlRootAttribute("DepartmentsDataSet"),  _
...
Partial Public Class DepartmentsDataSet
    ...
    Partial Public Class DepartmentDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddDepartmentRow(ByVal Name As String, ByVal GroupName As String) As DepartmentRow
            Dim rowDepartmentRow As DepartmentRow = CType(Me.NewRow,DepartmentRow)
            rowDepartmentRow.ItemArray = New Object() {Nothing, Name, GroupName}
...
Namespace DepartmentsDataSetTableAdapters
    ...
    Partial Public Class DepartmentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [HumanResources].[Department] ([Name], [GroupName]) VALUES (@Name, @G"& _ 
                "roupName);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT DepartmentID, Name, GroupName FROM HumanResources.Department "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [HumanResources].[Department] SET [Name] = @Name, [GroupName] = @GroupName"& _ 
                " WHERE (([DepartmentID] = @Original_DepartmentID) AND ([Name] = @Original_Name) "& _ 
                "AND ([GroupName] = @Original_GroupName));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT DepartmentID, Name, GroupName "& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT DepartmentID, Name, GroupName FROM HumanResources.Department"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DepartmentsDataSet.DepartmentDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DepartmentsDataSet.DepartmentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DepartmentsDataSet.DepartmentDataTable = New DepartmentsDataSet.DepartmentDataTable
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DepartmentsDataSet.DepartmentDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_DepartmentID As Short, ByVal Original_Name As String, ByVal Original_GroupName As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal GroupName As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal GroupName As String, ByVal Original_DepartmentID As Short, ByVal Original_Name As String, ByVal Original_GroupName As String, ByVal DepartmentID As Integer) As Integer
            If (Name Is Nothing) Then
                Throw New System.ArgumentNullException("Name")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(2).Value = CType(Original_DepartmentID,Short)
            If (Original_Name Is Nothing) Then
                Throw New System.ArgumentNullException("Original_Name")
            Else
